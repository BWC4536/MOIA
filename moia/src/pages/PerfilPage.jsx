  ...
  return (
    <main className="flex-1 px-12 py-12">
      ...
      >
        {/* Hero del perfil */}
        <motion.div
          custom={0} variants={fadeUp} initial={itemInit}
        ...
        <motion.div custom={1} variants={fadeUp} initial={itemInit}>
        ...
        {insigniasDesbloqueadas.length < INSIGNIAS_CATALOGO.length && (
          <motion.div
            custom={2} variants={fadeUp} initial={itemInit}
